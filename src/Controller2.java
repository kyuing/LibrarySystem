...
//								
//							}else {
//								System.out.println("* The book's queue has no record about the readers");
//								System.out.println("* The reader must be registered in the book's queue"
//												+ "  \nIn order for ");
//								
//								
//								//this can be too much work as well.
////								String yn = IO.menu(IO.printWaitingQueueMenu(), "[a-zA-Z]++");
//								//maybe, just inform that you have to go back to menu and then register a queue
////								if(yn.equalsIgnoreCase("y")) {
////								    if(rent.get(rtIdToInt-1).isRented()) {
////								    	(books.get(bIdToIndex)
////								    }
////								}
//								
//							}
...
//							
////							System.out.println(IO.printUnderLine());
////							System.out.println("* The reader is not in the first queue to be able to rent this book");
//////							System.out.println(books.get(bIdToIndex).getFirstInQueue());
////							System.out.println("\n[The book info]");
////							System.out.println(books.get(bIdToIndex));
////							System.out.println("\n[The matching info of the reader in the book's queue]");
////							System.out.println(books.get(bIdToIndex).getMQ().equalsCustomToString(rID));
////							System.out.println("\n\n* Please inform the reader that the reader that \n  he/she is not in the first queue to rent the book");
//							//if wanted, print the full queue list here
//						}
//				
//					}
//
...
//								&& !books.get(i).getMQ().equalsCustom(rID)) {
...
//							
//							System.out.println(books.get(i).getQueueToString());	
...
//							System.out.println(books.get(i).getMQ().equalsCustomToString(rID));	
////						}
//						return null;
//
//					}else {
