...
public class Search_equalsIgnore_approach_test {
...
//		List<Readers> temp =  new ArrayList<>();
...
//		System.out.println(key);
         ...
         while (right >= left) {
             ...
             if ( key.equalsIgnoreCase(r.get(mid).getId())
            		 || key.equalsIgnoreCase(r.get(mid).getFname())
            		 || key.equalsIgnoreCase(r.get(mid).getLname()) ) {
